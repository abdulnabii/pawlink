...
export function Admin2FaChallenge({
  ...
  const handleGetCode = async () => {
    ...
    try {
      ...
      setSuccessMsg(data.message || "Security code dispatched to your email! Please check your inbox.");
    } catch (err: any) {
      ...
      <div className="relative w-full max-w-md bg-slate-900/90 backdrop-blur-2xl border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl z-10">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <p className="text-xs sm:text-sm text-slate-400 mt-1.5 leading-relaxed">
            Verify your identity via 6-digit email security code to access the PawLink operations console.
          </p>
        </div>
