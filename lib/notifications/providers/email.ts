          ...
          body: JSON.stringify({
            ...
            html: `
              <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; padding: 24px; max-width: 580px; margin: auto; border: 1px solid #e2e8f0; border-radius: 16px; background-color: #ffffff;">
                ...
                ${payload.dashboardUrl ? `<a href="${payload.dashboardUrl}" style="display: inline-block; background: #0d9488; color: white; padding: 12px 24px; text-decoration: none; border-radius: 10px; font-weight: bold; margin-top: 16px; font-size: 14px;">Open PawLink Console</a>` : ""}
                <hr style="border: none; border-top: 1px solid #e2e8f0; margin: 24px 0;" />
                <p style="font-size: 12px; color: #94a3b8; margin: 0;">This is an automated security notification from PawLink. If you did not request this, please review your account.</p>
              </div>
            `,
          }),
        });
